...
define Device/qihoo_360t7-hanwckfuboot
  DEVICE_VENDOR := Qihoo
  DEVICE_MODEL := 360T7
  DEVICE_VARIANT := (hanwckf's U-Boot layout)
  DEVICE_DTS := mt7981b-qihoo-360t7-hanwckfuboot
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  SUPPORTED_DEVICES += qihoo,360t7-hanwckfuboot
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  KERNEL_INITRAMFS = kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd
endef
TARGET_DEVICES += qihoo_360t7-hanwckfuboot
...
define Device/tplink_wma301-v2-common
  ...
  IMAGE/sysupgrade.itb := append-kernel | \
        fit gzip $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb external-static-with-rootfs | append-metadata
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7981-bl2 tplink-wma301-v2-ddr3
endef

define Device/tplink_wma301-v2
  DEVICE_MODEL := WMA301 v2.0
  DEVICE_DTS := mt7981b-tplink-wma301-v2
  SUPPORTED_DEVICES += tplink,wma301-v2 mediatek,mt7981
